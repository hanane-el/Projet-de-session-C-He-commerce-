...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px;background-image: url('img/SD.jpg'); width:100%;height:100%;margin-top:-60px;margin-bottom:-60px;">
...
<!-- Work Section -->
  ...
  <h3 class="w3-center">Nos chaussures</h3>
  <p class="w3-center w3-large"></p>
 <div style="display:inline-block;">
 <?php    $reponse = $connect->query("SELECT * FROM produits WHERE type='chaussures'");
 ...
 <!-- <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
       <a href="products.html"><img src="img2/products/CH10.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" >
    </a>
          <div class="w3-container">
          
          <p class="w3-opacity">ballerines</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div></div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/CH11.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"></a><div class="w3-container">
          
          <p class="w3-opacity">sandales talon</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div>
    </div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/CH3.jpg" style="width:100%; height:350px; " onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/CH4.jpg" style="width:100%; height:350px; " onclick="onClick(this)" class="w3-hover-opacity" alt="Soundbox"></a><div class="w3-container">
          
          <p class="w3-opacity">escarpins</p>
 ...
 <!-- <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
       <a href="products.html"><img src="img2/products/CH6.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" >
    </a>
          <div class="w3-container">
          
          <p class="w3-opacity">baskets</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div></div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/CH8.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/CH5.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/CH9.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="Soundbox"></a><div class="w3-container">
