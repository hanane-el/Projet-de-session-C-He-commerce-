...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:138px;background-image: url('img/slider-1.jpg'); width:100%;height:120%;margin-top:-60px;margin-bottom:-60px;">
...
<!-- Work Section -->
  ...
  <h3 class="w3-center">Nos vetements</h3>
  <p class="w3-center w3-large"></p>
    <div style="display:inline-block;">
 <?php    $reponse = $connect->query("SELECT * FROM produits WHERE type='vetements'");
   ...
   <!-- <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/w3.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"></a><div class="w3-container">
          
          <p class="w3-opacity">tricot laine</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div>
    </div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/w9.jpg" style="width:100%; height:350px; " onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"></a><div class="w3-container">
          
          <p class="w3-opacity">jacket fourrure</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div>
    </div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/im8.jpg" style="width:100%; height:350px; " onclick="onClick(this)" class="w3-hover-opacity" alt="Soundbox"></a><div class="w3-container">
          
          <p class="w3-opacity">pontalon droit</p>
 ...
 <!-- <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
       <a href="products.html"><img src="img2/products/im6.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" >
    </a>
          <div class="w3-container">
          
          <p class="w3-opacity">robe</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div></div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/im5.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/w4.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"></a><div class="w3-container">
          
          <p class="w3-opacity">blazzer</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div>
    </div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/w6.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="Soundbox"></a><div class="w3-container">
          
          <p class="w3-opacity">jean</p>
