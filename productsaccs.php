...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding-top:158px;background-image: url('img/SS.jpg'); width:120%;height:95%;margin-top:-0px;margin-bottom:-60px;margin-left:-180px;margin-right:-40px;padding-right:-60px; ">
    ...
    <span class="w3-large" style="margin:55%;font-family:initial;font-weight:bold;font-size: xx-large;font-variant-caps: titling-caps;  ">
     <CENTER> <h1>Découvrez nos articles!</h1></CENTER></span>
...
<!-- Work Section -->
  ...
  <h3 class="w3-center">Nos accessoirs</h3>
  <p class="w3-center w3-large"></p>
 <div style="display:inline-block;">
 <?php    $reponse = $connect->query("SELECT * FROM produits WHERE type='accessoires'");
 ...
 <!-- <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
       <a href="products.html"><img src="img2/products/AC1.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" >
    </a>
          <div class="w3-container">
          
          <p class="w3-opacity">boucles rose gold</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div></div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/AC2.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"></a><div class="w3-container">
          
          <p class="w3-opacity">ensemble bracelets</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div>
    </div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/AC3.jpg" style="width:100%; height:350px; " onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/AC4.jpg" style="width:100%; height:350px; " onclick="onClick(this)" class="w3-hover-opacity" alt="Soundbox"></a><div class="w3-container">
          
          <p class="w3-opacity">collier</p>
  ...
  <!--<div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
       <a href="products.html"><img src="img2/products/AC6.jpeg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" >
    </a>
          <div class="w3-container">
          
          <p class="w3-opacity">chapeau</p>
          
          <p><button class="w3-button w3-light-grey w3-block"><i class='fas fa-plus-circle'></i>    details</button></p>
        </div></div>
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/AC8.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A phone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/AC9.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="A drone"></a><div class="w3-container">
    ...
    <div class="w3-col l3 m6">
      <a href="products.html"><img src="img2/products/ACC.jpg" style="width:100%; height:350px;" onclick="onClick(this)" class="w3-hover-opacity" alt="Soundbox"></a><div class="w3-container">
          
          <p class="w3-opacity">casquette</p>
